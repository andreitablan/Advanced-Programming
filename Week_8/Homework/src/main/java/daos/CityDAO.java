...
public class CityDAO {
    ...
    /**
     * This is used to get the maximum numbers of Cities
     * @return
     * @throws SQLException
     */
    public Integer getMaximId()throws SQLException{

        Connection connection = Database.getConnection();
        try (Statement statement = connection.createStatement();
             ResultSet rs = statement.executeQuery(
                     "select id from cities where id=(select MAX(id) from cities)")) {
    ...
    /**
     * This method gets the latitude of a city using the city id.
     */
    public Double getCityLatitudeById(Integer id) throws SQLException {
        Connection connection = Database.getConnection();
        try (Statement statement = connection.createStatement();
             ResultSet rs = statement.executeQuery(
    ...
    /**
     * This method gets the longitude using the city id.
     */
    public Double getCityLongitudeById(Integer id) throws SQLException {
        Connection connection = Database.getConnection();
        try (Statement statement = connection.createStatement();
             ResultSet rs = statement.executeQuery(
    ...
    /**
     * We get the city name by id
     * @param id
     * @return
     * @throws SQLException
     */
    public String getCityNameById(Integer id) throws SQLException {
        Connection connection = Database.getConnection();
        try (Statement statement = connection.createStatement();
             ResultSet rs = statement.executeQuery(
